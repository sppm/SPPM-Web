...
No cpan você encontra todo tipo de módulos perl... desde aplicações do google, do twitter, do facebook, etc, implementações de algoritmos de fórmulas bancárias, diversos frameworks, middlewares, bots, ide, servidor web, proxy, o que você imaginar alguém já deve ter implementado e adicionado ao cpan.
...
A maneira mais fácil para gerar o arquivo.tar.gz para seu módulo é através de um 'make dist'.
...
*** Você também pode instalar através utilizando "cpan Modulo::Para::Instalacao"
