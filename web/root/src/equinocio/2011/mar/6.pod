...
Do módulos que utilizam LCS podemos citar o L<Algorithm::LCS>[4] e o L<Algorithm::Diff>[5], entre outros. A ideia básica aqui é calcular o tamanho da maior substring em comum e comparar com as strings completas.
