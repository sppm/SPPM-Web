...
A L<PDF::API2> é uma boa biblioteca, com comandos fáceis e já tem "tudo" pronto (rotate, translste...) porém é lenta.
...
Com base na ideia/código do L<http://rick.measham.id.au/pdf-api2/>, montei outra classe para construir textos com e sem negritos, usando tags HTML (tipo o L<PDF::TextBlock>, mas sem o bug do center/right e com algumas coisas a mais, tipo o debug_rect ou o all_text)
...
Renato CRON  L<http://renatocron.com>
