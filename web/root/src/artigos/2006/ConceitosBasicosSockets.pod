...
poderosa e flexivel, e fornece ao usuário uma E<oacute>tima interface
...
B<IMPORTANTE>: E<Eacute> necessário um conhecimento bE<aacute>sico em
Perl e TCP/IP.

=head2 1.1. Afinal o que sE<atilde>o sockets?

Seria impossível explicar detalhadamente o que sE<atilde>o sockets
...
Caso nE<atilde>o for possível criar a socket serE<aacute> exibida uma
