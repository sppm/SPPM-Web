...
<p><a class="hover" onclick="switchExpand('múnicode');" title="clique para expandir">únicode</a></p>
<div id="múnicode">
...
collapseAll(['mRedirect','mCookie','mSession','mFlash','mParam','mRender','mRes','mLogging','mI18n','múnicode','mLadder','mWS','mTestes']);
//-->
</script>
