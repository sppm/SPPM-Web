...
possívelmente modificando o ambiente de execução antes da aplicação, ou
...
Com a grande quantidade de middlewares disponíveis, eventualmente vamos
...
Agora, a página 'text/plain' que tínhamos antes, virou uma página
