...
Agora no segundo template, colocaremos uma variável chamada "just_check", se o captcha estiver correto ela será setada para "o usuário digitou certo"
...
Quando se faz o $c->forwared('captcha_check') automaticamente o atributo
...
Daniel de Oliveira Mantovani <daniel.oliveira.mantovani@gmail.com>, trabalha atualmente na empresa DND L<http://www.dnd.com.br/>
