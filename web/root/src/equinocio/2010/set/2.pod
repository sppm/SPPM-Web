...
abstrair a construçãoo das querys SQL já voltadas ao SQLite, dando
...
Agora vejamos como poderíamos obter um ou mais registros da nossa base de
...
utilizando a clausula WHERE do SQL. Vamos ver como poderíamos fazer!
...
ideia simples do uso deste ótimo modulo para auxiliar-nos na manipulação de
