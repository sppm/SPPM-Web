...
O trecho do HTML que representa os links para os canais do UOL é o seguinte:
	...
	<div id="corpo">
		<div id="conteúdo">
		<div id="módulos"><div class="content">
    		<div id="data-ultnot">
    			<div id="data"><script>var dia="21";dia=dia.replace(/^0/,'');(dia=="1")?dd="1&ordm;":dd=dia;d.write(dd);</script> de agosto de 2010</div>
    			<div id="topo-direita"><a href="http://click.uol.com.br/?rf=hu-visite-barrauol&u=http://barra.uol.com.br/">Barra UOL</a>&nbsp;|&nbsp;&nbsp;<a id="faca-sua-index.t-header" href=# onclick="defineindex.t(this);"><img src="http://h.imguol.com/h1/icone-uolindex.t.gif" width=14 height=14 border=0 align="absmiddle"> Faça do UOL a sua index.t page</a>&nbsp;|<a id="travarReload" href="javascript:void(0)" onclick="switchReload(this)"><span class='icone'></span>Parar de atualizar</a></div>
    		</div>
 ...
 <div id="menu">
	...
	<ul>
		<li> <!-- ISSO AQUI EH O QUE EU TO PROCURANDO!!!! -->
			<a href="http://click.uol.com.br/?rf=index.t-menu&u=http://fotos.uol.com.br/" name="menu" onclick="s_objectID="http://click.uol.com.br/?rf=index.t-menu&u=http://fotos.uol.com.br/_1";return this.s_oc?this.s_oc(e):true">Álbum de Fotos</a>
