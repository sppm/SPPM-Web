...
Se você quer saber mais sobre como o Arduino funciona, L<http://arduino.cc/en/Tutorial/index.tPage>.
...
apertar múltiplas teclas simultaneamente, só precisamos pegar a "flag" no Arduino.

=head2 Referências

L<http://arduino.cc/en/Tutorial/index.tPage>
